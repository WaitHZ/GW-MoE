...
try:
    nltk.data.find("tokenizers/punkt", paths=['./'])
...
class ModelArguments:
    ...
    decoder_train_use_gw: bool = field(
        default=bool,
    )
    decoder_eval_use_gw: bool = field(
        default=False,
    )
    gw_entropy_threshhold: float = field(
        default=1.5,
    )
    decoder_max_num_slots: int = field(
        default=-1
    )
    encoder_train_use_gw: bool = field(
        default=bool,
    )
    encoder_eval_use_gw: bool = field(
        default=False,
    )
    encoder_max_num_slots: int = field(
        default=-1
    )
...
class DataTrainingArguments:
    ...
    dataset_config_name: Optional[str] = field(
        default="default", metadata={"help": "The configuration name of the dataset to use (via the datasets library)."}
    )
...
def main():
    ...
    setattr(config, 'router_z_loss_coef', 0.)

    setattr(config, 'gw_entropy_threshhold', model_args.gw_entropy_threshhold)
    
    setattr(config, 'decoder_train_use_gw', model_args.decoder_train_use_gw)
    setattr(config, 'decoder_eval_use_gw', model_args.decoder_eval_use_gw)
    setattr(config, 'decoder_max_num_slots', model_args.decoder_max_num_slots)
    
    setattr(config, 'encoder_train_use_gw', model_args.encoder_train_use_gw)
    setattr(config, 'encoder_eval_use_gw', model_args.encoder_eval_use_gw)
    setattr(config, 'encoder_max_num_slots', model_args.encoder_max_num_slots)
    ...
    def freeze_router(model):
        print("Freezing Router's weight.")

...
class MRPC(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/cpfs01/projects-HDD/cfff-23ba4487e9df_HDD/wangzili/whz/data/datasets/mrpc')[split]
...
class COLA(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/cpfs01/projects-HDD/cfff-23ba4487e9df_HDD/wangzili/whz/data/datasets/cola')[split]
...
class SST2(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/cpfs01/projects-HDD/cfff-23ba4487e9df_HDD/wangzili/whz/data/datasets/sst2')[split]
...
class STSB(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/cpfs01/projects-HDD/cfff-23ba4487e9df_HDD/wangzili/whz/data/datasets/stsb')[split]
...
class QQP(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/cpfs01/projects-HDD/cfff-23ba4487e9df_HDD/wangzili/whz/data/datasets/qqp')[split]
...
class MNLI(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/cpfs01/projects-HDD/cfff-23ba4487e9df_HDD/wangzili/whz/data/datasets/mnli')[split]
...
class QNLI(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/cpfs01/projects-HDD/cfff-23ba4487e9df_HDD/wangzili/whz/data/datasets/qnli')[split]
...
class RTE(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/cpfs01/projects-HDD/cfff-23ba4487e9df_HDD/wangzili/whz/data/datasets/rte')[split]
...
class WNLI(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/cpfs01/projects-HDD/cfff-23ba4487e9df_HDD/wangzili/whz/data/datasets/wnli')[split]
...
class SuperGLUERTE(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/super_rte')[split]
...
class SuperGLUEWSCFixed(AbstractTask):
    ...
    def load_dataset(self, split):
        return load_from_disk('/aifs4su/data/zhaohao/wscfixed')[split]

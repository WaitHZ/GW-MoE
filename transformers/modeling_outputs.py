...
class Seq2SeqMoEOutput(ModelOutput):
    ...
    encoder_entropy: torch.FloatTensor = None
    decoder_entropy: torch.FloatTensor = None
    encoder_gw_ratio: torch.FloatTensor = None
    decoder_gw_ratio: torch.FloatTensor = None
    past_key_values: Optional[Tuple[Tuple[torch.FloatTensor]]] = None
    decoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    decoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
    decoder_router_logits: Optional[Tuple[torch.FloatTensor]] = None
